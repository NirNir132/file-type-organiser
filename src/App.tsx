...
import { AlertTriangle, Download, Layout, List } from "lucide-react";
		...
		<div className="min-h-screen bg-gradient-to-br from-sky-100 via-indigo-50 to-purple-50 py-8 px-4 sm:px-6 lg:px-8">
			<div className="max-w-7xl mx-auto">
				...
				<header className="mb-8 text-center">
					...
					<p className="text-lg text-slate-700/90 max-w-3xl mx-auto">
						Drag & drop folders to visualize their structure, search files,
						apply advanced filters, and download organized collections. All
							...
							<div className="lg:col-span-3">
								{viewMode === "tree" ? (
									...
									<FileList
										...
										isZipping={isZipping}
										targetExtension={filters.fileTypes.join(", ") || "filtered"}
									/>
								)}
							</div>
						</div>
						...
						<div className="bg-white/90 backdrop-blur-sm shadow-2xl rounded-2xl p-8 border border-slate-200/50">
							<div className="text-center mb-8">
								...
								<p className="text-slate-600 max-w-2xl mx-auto">
									Discover detailed information about file formats, their uses,
									and best practices. Your complete reference guide to digital
									file types.
								</p>
							</div>
